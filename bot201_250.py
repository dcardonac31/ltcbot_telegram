            ...
            for ulang in range(999999999):          
               ...
               # print(soup.text)
                ...
                if soup.text.find('Checking your browser before accessing doge.click'):
                    ...
                    print(blue + "Wait 15 s")
                    sleep(5)
                    webbrowser.register('maxthon',
                    	None,
                    	webbrowser.BackgroundBrowser("C:/Program Files (x86)/Maxthon5/Bin/Maxthon.exe"))
                    webbrowser.get('maxthon').open(url)
                    print(red+"--------------> Validation Cloudflare <-------------")
                    sleep(60)
                    os.startfile("C:/Users/david/Downloads/MEmu Download/bot_ltc/ltcbot_telegram/taskkillMaxthon.bat")
                    sleep(3)
