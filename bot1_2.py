        ...
        try:
            for ulang in range(999999999):
                ...
                if url == urlaux:
                    ...
                    print(red+'\rSuccessfully Skip Task\n')                   
            ...
            sentence_insert_balance ="INSERT INTO public.balanceltcbotsecond(idbotsecond, datetimeexecution, balance) VALUES (%s, %s, %s);"
