               ...
               # print(soup.text)
                ...
                if soup.text.find('Checking your browser before accessing doge.click'):
                    ...
                    webbrowser.register('opera',
                    	None,
                    	webbrowser.BackgroundBrowser("C:/Users/david/AppData/Local/Programs/Opera/launcher.exe"))
                    webbrowser.get('opera').open(url)
                    print(red+"--------------> Validation Cloudflare <-------------")
                    sleep(60)
                    os.startfile("C:/Users/david/Downloads/MEmu Download/bot_ltc/ltcbot_telegram/taskkillOpera.bat")
                    sleep(3)
