               ...
               # print(soup.text)
                ...
                if soup.text.find('Checking your browser before accessing doge.click'):
                    ...
                    webbrowser.register('vivaldi',
                    	None,
                    	webbrowser.BackgroundBrowser("C:/Users/david/AppData/Local/Vivaldi/Application/vivaldi.exe"))
                    webbrowser.get('vivaldi').open(url)
                    print(red+"--------------> Validation Cloudflare <-------------")
                    sleep(60)
                    os.startfile("C:/Users/david/Downloads/MEmu Download/bot_ltc/ltcbot_telegram/taskkillVivaldi.bat")
                    sleep(3)
